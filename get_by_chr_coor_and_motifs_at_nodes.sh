...
run_file=${PROJDIR}/run_by_chr_get_motifs_at_nodes_${day}_thres_${thres}_${set}_${contacts}.sh
...
qsub -o $PROJDIR/o.get_by_chr_motifs_at_nodes_${day}_thres_${thres}_${set}_${contacts} -e $PROJDIR/e.run_by_chr_get_motifs_at_nodes_${day}_thres_${thres}_${set}_${contacts} $run_file
