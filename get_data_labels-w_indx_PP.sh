...
InteractionsFileCaptureC_zipped='/mnt/lab_data/kundaje/mtaranov/ChicagoCalls/D0_D2D8_merge_BaitToBait_intra.bed.gz'
...
output_dir=${PROJDIR}'/dist_matched_PP'
mkdir -p $output_dir

run_file=${PROJDIR}'/run_get_data_labels-w_indx_PP.sh'
...
qsub -o $PROJDIR/o.run_get_data_labels-w_indx_PP -e $PROJDIR/e.run_get_data_labels-w_indx_PP $run_file
